...
//  Virtual Tourist
//
//  Created by Khoa Vo on 12/23/15.
...
class CoreDataStackManager {
    ...
    */
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.AppSynth.Virtual_Tourist" in the application's documents Application Support directory.
